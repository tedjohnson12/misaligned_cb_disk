...
def test_cast_r_and_theta():
    ...
    r,theta = integrate.cast_r_and_theta(r,theta)
    ...
    outfile = Path(__file__).parent / 'output' / 'r_and_theta_recast.png'
    
    fig.savefig(outfile, facecolor='w')
    
if __name__ in '__main__':
    test_cast_r_and_theta()